! function(n, e, t) {
    ...
    9: [function(n, e, t) {
        function r(n) {
            if (n.info.beacon) {
                ...
                if (t) {
                    ...
                    b.jsonp("https://" + n.info.beacon + "/" + r + "/" + n.info.licenseKey + u, T)
                }
            }
        }
        ...
        function u(n, e, t, r) {
            ...
            r || (r = {});
            var o = "https://" + e.info.errorBeacon + "/" + n + "/1/" + e.info.licenseKey + l(e);
        ...
        function l(n) {
            return ["?a=" + n.info.applicationID, g.param("sa", n.info.sa ? "" + n.info.sa : ""), g.param("v", A), f(n), g.param("ct", n.customTransaction), "&rst=" + n.now(), g.param("ref", S(E.getLocation()))].join("")
        }
    ...
    11: [function(n, e, t) {
        function r(n) {
            u.sendFinal(d, !1), i.navCookie && (document.cookie = "NREUM=s=" + Number(new Date) + "&r=" + o(document.location.href) + "&p=" + o(document.referrer) + "; path=/")
        }
        var o = n(17),
            i = n(19),
            a = n(20),
        ...
        window.NREUM.setToken = f, 6 === n(10) ? d.maxBytes = 2e3 : d.maxBytes = 3e4, d.releaseIds = {}, s(r), c("mark", a.mark, "api"), a.mark("done"), l("api"), p && u.sendRUM(d)
    }, {}],
    12: [function(n, e, t) {
        e.exports = function(n, e) {
    ...
    23: [function(n, e, t) {
        ...
        function a(n) {
            ...
            return n.forEach(function(r, o) {
                t += "e,", t += e(r.name) + ",", t += s(r.value, u, !1) + ",";
                var i = f(r.attrs, e);
                i && i.length > 0 && (t += i.length + ";" + i.join(";")), o + 1 < n.length && (t += ";")
            }), t
        }
        var s = n(4).nullable,
            u = n(4).numeric,
            c = n(4).getAddStringContext,
            f = n(4).addCustomAttributes;
        if (e.exports = {
                getPayload: a
            ...
            var d = n("loader"),
                ...
                h = 30,
                g = [];
            p("timing", r), v(i), setTimeout(function() {
                o(), m(o, 1e3 * h)
            }, 1e4)
        }
    }, {}],
    ...
    28: [function(n, e, t) {
        ...
        function s(n, e, t, o) {
            ...
            if (e = e || p.now(), t || !p.onerror || !p.onerror(n)) {
                ...
                c.message && (m.message = "" + c.message), v[m.stackHash] ? m.browser_stack_hash = l(c.stackString) : (v[m.stackHash] = !0, m.stack_trace = c.stackString), m.releaseIds = w(p.releaseIds);
                var g = r(m);
    ...
    31: [function(n, e, t) {
        ...
        function h(n) {
            ...
            return function(o, i) {
                ...
                a || (a = o[i.o] = []);
                var s = r[i.o];
                return "scrolling" !== n || b(i) ? s && i.s - s.s < t && s.e > i.s - e ? s.e = i.e : (r[i.o] = i, a.push(i)) : (r[i.o] = null, i.n = "scroll", a.push(i)), o
            }
        }
            ...
            if (e.exports = {
                ...
                M.on("feat-stn", function() {
                    ...
                    n.addEventListener("load", function() {
                        N = this.responseText
                    }, !1), x("bst", i), x("bstTimer", o), x("bstResource", c), x("bstHist", u), x("bstXhrAgg", d), x("bstApi", l), x("errorAgg", f), _(function() {
                        var n = 0;
                        return w.now() > 9e5 ? void(C = {}) : (j(C, function(e, t) {
                            t && t.length && (n += t.length)
                        }), n > 30 && k.sendX("resources", w), void(n > 1e3 && (C = {})))
                    }, 1e4)
                });
                var L = 0
            }
